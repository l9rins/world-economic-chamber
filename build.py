  ...
  <nav class="nav" id="mainNav">
    <div class="nav-inner">
      ...
      <ul class="nav-menu" id="navMenu">
        ...
        <li class="nav-item">
          <a href="charter.html" class="nav-link">Charter <svg class="nav-arrow" viewBox="0 0 24 24" width="12" height="12" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="6 9 12 15 18 9"></polyline></svg></a>
          <div class="nav-dropdown">
    ...
    <div class="container">
      <div class="feature-grid stagger">
        <div class="feature-item">
          <div class="feature-icon" style="background: rgba(10,88,166,0.12); color: var(--pillar-governance);"><svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="2" fill="none" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg></div>
          <h4>Principled Governance</h4>
          <p>Institutional integrity as a core operating principle</p>
        </div>
        <div class="feature-item">
          <div class="feature-icon" style="background: rgba(17,129,67,0.12); color: var(--pillar-trade);"><svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="2" fill="none" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="M2 12h20"></path><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg></div>
          <h4>Global Reach</h4>
          <p>Operating across jurisdictions with neutrality</p>
        </div>
        <div class="feature-item">
          <div class="feature-icon" style="background: rgba(210,38,39,0.12); color: var(--pillar-oversight);"><svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="2" fill="none" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></div>
          <h4>Institutional Leadership</h4>
          <p>Structured, accountable governance architecture</p>
        </div>
        <div class="feature-item">
          <div class="feature-icon" style="background: rgba(239,125,0,0.12); color: var(--pillar-cooperation);"><svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="2" fill="none" aria-hidden="true"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline><polyline points="16 7 22 7 22 13"></polyline></svg></div>
...
""" + CONSTELLATION_SVG + """
  ...
  <section class="section" id="sections">
    <div class="container">
      ...
      <div class="grid grid-3 stagger" style="margin-top: var(--space-3xl);">
  ...
  <section class="section section-dark">
    <div class="container">
      ...
      <div class="testimonials stagger" style="margin-top: var(--space-3xl);">
  ...
  <section class="section-sm section-alt">
    <div class="container">
      <div class="text-center fade-in">
        <span class="section-label">Institutional Partners</span>
        <h2 class="section-title">Trusted by Leading Organisations</h2>
        <div class="divider divider-center divider-thick"></div>
      </div>
      <div class="partner-grid" style="margin-top: var(--space-2xl);">
        <div class="partner-item">
          <span class="partner-name">European Business Council</span>
          <span class="partner-desc">International Trade Directorate</span>
        </div>
        <div class="partner-item">
          <span class="partner-name">ASEAN</span>
          <span class="partner-desc">Economic Cooperation Secretariat</span>
        </div>
        <div class="partner-item">
          <span class="partner-name">African Development Bank</span>
          <span class="partner-desc">Chief Economist Office</span>
        </div>
        <div class="partner-item">
          <span class="partner-name">Deloitte</span>
          <span class="partner-desc">Global Markets Practice</span>
        </div>
        <div class="partner-item">
          <span class="partner-name">European Investment Bank</span>
          <span class="partner-desc">Institutional Partnerships</span>
        </div>
        <div class="partner-item">
          <span class="partner-name">UN Global Compact</span>
          <span class="partner-desc">Private Sector Engagement</span>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-sm section-dark">
    <div class="container">
      <div class="newsletter-box fade-in">
        ...
        <form class="newsletter-form" action="mailto:info@worldeconomicchamber.com" method="post" enctype="text/plain" onsubmit="this.querySelector('.btn').textContent='Thank you';this.querySelector('.btn').style.pointerEvents='none';setTimeout(()=>{this.querySelector('.btn').textContent='Subscribe';this.querySelector('.btn').style.pointerEvents=''},3000);">
